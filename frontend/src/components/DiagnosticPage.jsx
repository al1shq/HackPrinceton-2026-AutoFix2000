// Generated by orchid
// modified by Alisha Owaise for certain changed in UI
// major changes include the parsing from the K2 response and the addition of a text box for every single question
// parsing now handleled in backend, server.js
